...
public class CardPayListViewAdapter extends BaseAdapter {
	private List<EveryFee> everyFees;
	private Context context;
	private LayoutInflater inflater;

	public CardPayListViewAdapter(List<EveryFee> everyFees, Context context) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = this.inflater.inflate(
					R.layout.card_paylistview_item_layout, null);
