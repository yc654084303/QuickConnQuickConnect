...
public class DesPlus {
 ...
 /**
	 ...
	 * @throws Exception
	 */
	public final static String desDecode(String decrypt, String key)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	public final static String desEncode(String cryptic, String key)
			throws Exception {
		DesPlus des = new DesPlus(key);
		return des.encrypt(cryptic);
	}
	 ...
	 * @throws Exception
	 */
	public String DataEncrypt(String str, String key)
